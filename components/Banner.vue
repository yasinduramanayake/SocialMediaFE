<template>
  <div class="banner_body">
    ...
    <b-row no-gutters>
          ...
          <div class="star_banner">
            <div class="rating-info">
              ...
              <svg
                ...
                fill="none"
              >
                <g filter="url(#filter0_ii_201_2400)">
                  <path
                ...
                <defs>
                  ...
                  >
                    ...
                    <feColorMatrix
                      type="matrix"
                      values="0 0 0 0 0.85 0 0 0 0 0.312021 0 0 0 0 0.0814583 0 0 0 0.42 0"
                    ></feColorMatrix>
                    <feBlend
                      mode="normal"
                      in2="shape"
                      result="effect1_innerShadow_201_2400"
                    ></feBlend>
                    <feColorMatrix
                      in="SourceAlpha"
                      type="matrix"
                    ...
                    <feBlend
                      mode="normal"
                      in2="effect1_innerShadow_201_2400"
                      result="effect2_innerShadow_201_2400"
                    ></feBlend>
                  </filter>
                </defs>
              </svg>
      ...
      <b-col lg="6" class="mobile_banner_image">
        <div>
          <b-img height="600px" width="900px" src="@/assets/images/Amaz-min.png"></b-img>
        </div>
      </b-col>
    </b-row>
